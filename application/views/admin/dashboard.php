...
<head>
    ...
    <title>Admin | SMAN 8 Jakarta</title>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mx-auto d-block">
                            <img class="rounded-circle mx-auto d-block" src="<?php echo base_url()?>images/logo_8.png" alt="Card image cap" width="150" height="150">
                            <h5 class="text-sm-center mt-2 mb-1">Selamat Datang</h5>
                            <div class="location text-sm-center"> Administrator SMAN 8 Jakarta</div>
                        </div>
                        <hr>
                    </div>
                </div>

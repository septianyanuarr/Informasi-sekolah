		  ...
		  <header id="header" id="home">
		    ...
		    <div class="container main-menu">
		    	<div class="row align-items-center justify-content-between d-flex">
			      <div id="logo">
			        <a href="<?php echo base_url() ?>user"><img src="<?php echo base_url() ?>images/logo_8.png" width="80" title="" /></a>
			      </div>
			...
			<!-- start banner Area -->
			<section class="banner-area relative" id="home"  style="background: url(<?php echo base_url() ?>assets_user/img/background.JPG);">
			...
			<section class="popular-course-area section-gap">
				<div class="container">
					...
					<p>Alamat : Taman Bukit Duri No.2, RT.2/RW.12, Bukit Duri, Kec. Tebet, Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12840</p>
					<p>Telepon	:	(021) 8351782</p>
					<p>Email :  info@sman8jkt.sch.id</p>
				</div>	
			</section>
				...
				<div class="container">
					...
					<div class="footer-bottom row align-items-center justify-content-between">
						<p class="footer-text m-0 col-lg-6 col-md-12">
							Copyright &copy;<script>document.write(new Date().getFullYear());</script> Kelompok 2 | Sistem Informasi</p>
